...
interface BDRRMC {
  ...
  const Bdrrmc: React.FC = () => {
    ...
    useEffect(() => {
      ...
      var getclearance = async () =>{
        await axios.get(api_url+'bdrrmc')
  ...
  const saveAsExcelFile = (buffer: BlobPart, fileName: string) => {
    ...
    const [individualResidents, setindividualResidents] = useState<BDRRMC | null>(null);
    ...
    async function CreateUserAPI(){
      ...
      var formatedValidityDate = format(DocumentValidityDate, 'MM/dd/yyyy');
        ...
        await axios.put(api_url+'bdrrmc', {
    ...
    async function AddNewRecord(){
      ...
      var formatedValidityDate = format(DocumentValidityDate, 'MM/dd/yyyy');
        ...
        await axios.post(api_url+'bdrrmc', {
          ID: parseInt(UpdateformData.ID),
          TypeOfRecord: selectedOptionCategory,
          PartiesInvolved: UpdateformData.PartiesInvolved,
          DateTime: formatedValidityDate,
        ...
        <Breadcrumbs aria-label="breadcrumb">
          ...
          >
            ...
            <div className="card flex justify-content-center">
                <Dialog header={modalState+" BDRRMC Record"}  visible={visible} style={{ width: '50vw' }} 
                onHide={() => {
                  setVisible(false);
                  setIsFormDisabled(false);
                  resetUpdateForm(); 
                  ...
                  <form className="flex flex-col my-4 gap-2">
                    ...
                    <div className="flex gap-4 pb-2">
                      <div className="pb-2 flex flex-col grow">
                        <label htmlFor="PhilhealthCategory" className="pb-2 col-form-label">Type of Record: <span className="text-red-500">*</span></label>
                        ...
                        name="category" value={selectedOptionCategory} onChange={handleSelectChangeCategory}  >
                          <option value="">Please Select one..</option>
                            ...
                            <option value="Others">Others (please specify on record details)</option>
                          </select>
                        </div>
                      <div className="pb-2 flex flex-col grow">
                        <label htmlFor="PartiesInvolved" className="pb-2 col-form-label">Party/ies involved:</label>
                        <input type="text" className="p-2 mt-[-2px] rounded-md border-2 border-grey" id="PartiesInvolved" name="PartiesInvolved"
                    ...
                    <div className="grid grid-cols-3 grid-rows-1 gap-4">
                      <div className="grid grid-cols-1 grid-rows-3 gap-4" style={{ maxWidth: '300px' }}>
                        <div className="flex flex-col">
                        <label className="pb-2 col-form-label" htmlFor="DocumentValidity">Date and Time <span className="text-red-500">*</span>
                        </label>
                          <DatePicker
                        ...
                        <div className="pb-2 flex flex-col row-span-2 ">
                          <label htmlFor="Location" className="pb-2 col-form-label">Location <span className="text-red-500">*</span></label>
                          <textarea
                        ...
                        <label htmlFor="RecordDetails">Record Details<span className="text-red-500">*</span></label>
                          <textarea
                            className="rounded-md  border-2 border-grey"
                            name="RecordDetails"
                            id="RecordDetails"
