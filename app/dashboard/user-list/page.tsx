...
export default function UserList() {
  ...
  async function CreateUserAPI(){
    ...
    var mname = (document.getElementById("middle-name") as HTMLInputElement).value;
    var lname = (document.getElementById("last-name") as HTMLInputElement).value;
    var posID = (document.getElementById("position") as HTMLInputElement).value;
    var email = (document.getElementById("email") as HTMLInputElement).value;
    var username = (document.getElementById("user-name") as HTMLInputElement).value;

    if (CreateUpdateHeader == "Create User"){
    
      if (fname == "" || mname == "" || lname == "" || posID == "" || email == "" || username == ""){
  ...
  const deleteUserDialogFooter = (
    <React.Fragment>
        ...
        <Button label="Yes" icon="pi pi-check" severity="danger" onClick={DeleteUserApi}/>
    </React.Fragment>
  );
  ...
  useEffect(() => {
    ...
    var getPositions = async () =>{
      await axios.get(api_url+"positions")
              ...
              footer={footerContent} position="top">
                ...
                <form className="flex flex-col my-4 gap-2">
                  ...
                  <div className="flex gap-4 pb-4">
                    <div className="pb-2 flex flex-col grow">
                     <label htmlFor="email" className="col-form-label">Email:</label>
                      <input type="text" className="p-2 mt-[-2px] rounded-md border-2 border-grey" id="email" name="email"
                    ...
                    <div className="pb-2 flex flex-col grow">
                      ...
                      <input type="text" className="p-2 mt-[-2px] rounded-md border-2 border-grey" id="user-name" name="userName"
                  ...
                  <div className="pb-2 flex flex-col grow">
                    ...
                    <select id="position" className="p-2 mt-[-2px] rounded-md border-2 border-grey" 
                    name="position" value={selectedOption} onChange={handleSelectChange}  >
