    ...
    <div className="px-8 py-4">
      ...
      <div className="flex gap-4 pb-4">
        <div className="pb-2 flex flex-col grow">
            <label style={{marginBottom:"10px"}} htmlFor="currentPassword" className="col-form-label">Current Password:</label>
            <input style={{marginBottom:"10px"}} type="password" className="p-2 mt-[-2px] rounded-md border-2 border-grey" id="currentPassword" name="currentPassword"
            value={UpdateformData.currentPassword}
            onChange={handleInputChange}
            ></input>
            <label style={{marginBottom:"10px"}} htmlFor="newPassword" className="col-form-label">New Password:</label>
            <input style={{marginBottom:"10px"}} type="password" className="p-2 mt-[-2px] rounded-md border-2 border-grey" id="newPassword" name="newPassword"
            value={UpdateformData.newPassword}
            onChange={handleInputChange}
            ></input>
            <label style={{marginBottom:"10px"}} htmlFor="confimPassword" className="col-form-label">Confirm Password:</label>
            <input style={{marginBottom:"10px"}} type="password" className="p-2 mt-[-2px] rounded-md border-2 border-grey" id="confimPassword" name="confimPassword"
