...
const ResidentsList: React.FC = () => {
  ...
  const printRowData = (individualResidents: any) => {
    ...
    var printDocumentURL =
      ...
      "/" +
      individualResidents.DocumentID +
      docuTypeUrl2 +
      individualResidents.ID +
      "_" +
      individualResidents.DocumentID +
  ...
  const onRowView = (individualResident: any) => {
    ...
    setSelectedOptionDocumentStatus(
      individualResident.DocumentData.DocumentStatus
    );
    setSelectedOptionCategory(
      individualResident.DocumentData.PhilHealthCategory
    );
    ...
    if (individualResident.DocumentType === "Barangay Clearance") {
      var datePartsValidity =
        individualResident.DocumentData.ValidUntil.split(/[\s:-]+/);
      var dateObjectValidity = new Date(
        parseInt(datePartsValidity[0]), // Year
        parseInt(datePartsValidity[1]) - 1, // Month
        parseInt(datePartsValidity[2]) // Day
  ...
  const actionStatusTemplate = (rowData: any) => {
    return (
      <Tag
        value={
          rowData.DocumentData.DocumentStatus == "Printing"
            ? "Printed"
            : rowData.DocumentData.DocumentStatus
        }
        ...
        >
          ...
          <form className="flex flex-col my-4 gap-2">
            ...
            <div className="flex gap-4 pb-2">
              ...
              <div className="pb-2 flex flex-col grow">
                <label htmlFor="philHealthID" className="col-form-label">
            ...
            <div className="flex gap-4 pb-2">
              ...
              <div className="pb-2 flex flex-col grow">
                <label htmlFor="hCGGGNumber" className="col-form-label">
            ...
            <div className="flex gap-4 pb-2">
              <div className="pb-2 flex flex-col w-3/12">
                <label htmlFor="guardianName" className="col-form-label">
            ...
            <div className="flex gap-4 pb-2">
              <div className="pb-2 flex flex-col grow">
                ...
                <input
                  type="text"
                  className="p-2 mt-[-2px] rounded-md border-2 border-grey"
                  id="gurdianContactNumbers"
                  name="gurdianContactNumbers"
              ...
              <div className="pb-2 flex flex-col grow">
                <label
                  htmlFor={
                    UpdateformData.documentType === "Barangay Indigency"
                      ? "reason"
                      : "purpose"
                  }
                  className="col-form-label"
