...
const HcReferrals: React.FC = () =>{
  ...
  const exportExcel = () => {
    import('xlsx').then(async (xlsx) => {
        const response = await axios.get(api_url+'referralsxl');
...
const saveAsExcelFile = (buffer: BlobPart, fileName: string) => {
  ...
  const onRowSelect = (event: any) => {
    ...
    setUpdateFormData({
      ...
      PhilhealthNum: event.data.PhilHealthID,
      Address: event.data.ResidentData.Address,
      HealthCardGGGNum: event.data.HCGGGNumber,
      ...
      reasonForReferral: event.data.ReasonForReferral,
    ...
    setSelectedOptionCategory(event.data.PhilHealthCategory);
  ...
  const onRowView = (individualResident: any) => {
    ...
    setUpdateFormData({
      ...
      PhilhealthNum: individualResident.PhilHealthID,
      Address: individualResident.ResidentData.Address,
      HealthCardGGGNum: individualResident.HCGGGNumber,
...
const getBackgroundColor = () => {
  ...
  async function CreateUserAPI(){
    ...
    // var formatedValidityDate = format(DocumentValidityDate, 'MM/dd/yyyy');
      ...
      await axios.put(api_url+'referrals', {
        ...
        HCGGGNumber: UpdateformData.HealthCardGGGNum,
        PhilHealthID: UpdateformData.PhilhealthNum,
  ...
  return(
    <div className="px-8 py-4">
      <h1 className="text-4xl font-black pt-4 text-red-900 tracking-[-0.5px] pb-2">Health Center Referral Records</h1>
      <Breadcrumbs aria-label="breadcrumb">
        ...
        <Typography
          ...
          color="text.primary"
        >
          Health Center Referral Records
        </Typography>
      </Breadcrumbs>
      <div className="flex justify-content-between gap-8 pb-4 pt-4">
          ...
          <div className="card flex justify-content-center">
              <Dialog header="Health Center Referral Record" visible={visible} style={{ width: '70vw' }} 
              onHide={() => {
                setVisible(false);
...
export default withLoading(HcReferrals);